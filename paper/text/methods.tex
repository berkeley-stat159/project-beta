...
%\caption{\label{fig:processflow} Project Flow for Regression}
%\end{figure}

%The above image illustrates the process undergone for regression analysis. For the Neural Network, the predictive model flows opposite, using scenes for

\subsection{Text Preprocessing}
\input{text/textpp.tex}

\subsection{FMRI Preprocessing}
\input{text/fmripp.tex}
